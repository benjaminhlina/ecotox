...
#'   }
#' @details For each month, new lamprey were collected from the deer creek, MI, and were randomly assigned to a tank for exposure to varying doses of the piscicide, 3-trifluoromethly-4-nitrophenol (TFM).
